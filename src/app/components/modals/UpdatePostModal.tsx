...
export default function UpdatePostModal({ onClose, post }: UpdatePostModalProps) {
    ...
    const {
      ...
      const onSubmit: SubmitHandler<FieldValues> = async (data) => {
        const res = await fetch("/api/updatePost", {
          method: "PUT",
          body: JSON.stringify({ postId: post?.id, ...data }),
        });
                ...
                <div className="p-6 lg:px-14 py-10 overflow-y-auto" style={{ maxHeight: 'calc(100vh - 80px)' }}>
                    ...
                    <form className="space-y-8 w-full" onSubmit={handleSubmit(onSubmit)}>
                        <div className="flex flex-col w-full">
                                ...
                                <h3 className="section-title font-semibold text-[18px] lg:text-4xl text-white !mb-4">Modifier votre annonce</h3>

...
const About = () => {
  return (
    <section className="section bg-white lg:mt-10 pb-8 lg:pt-14 lg:pb-14">
          <div className="grid grid-cols-1 gap-x-12 lg:grid-cols-6">
            <div className="lg:col-span-3 flex flex-col w-full justify-center">
              ...
              <div className="space-y-6"> 
                ...
                <div className="block lg:hidden my-6">
                  <Image src="/img/about/about-section.svg" alt="" width={500} height={500} />
            ...
            <div className="lg:col-span-3 hidden lg:block">
              <img src="/img/about/about-section.svg" alt="" />
            </div>  
